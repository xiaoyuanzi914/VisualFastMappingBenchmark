...
jsonl_path="/mnt/cfs_bj/liannan/visualicl_logs/processed_data/stage2/dataset/2025-04-24/Manufacture_manufacture-final_0.21_4_1050_11:54:51.476301_each_5_shots_demotextflag2_finepromptflag2_randomedemoflag4.jsonl"
...
demo_text_flag_list=(0 1 2)
# 0 for none, 1 for caption, 2 for caption and visual_intro
random_demo_flag_list=(0 1 2 3 4 5)
# 0 for none, 1 for exchange demo's text, 2 for fabrictae demo's text, 3 for swap image with blank, 4 for swap image with noise, 5 for replace negative example with noise
mask_demo_flag_list=(0 1 2 3)
# 0 for none, 1 for 100% mask, 2 for 50% mask, 3 for 33% mask
